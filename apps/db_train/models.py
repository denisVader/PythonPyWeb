...
class Author(models.Model):
    ...
    username = models.SlugField(verbose_name='Имя аккаунта', unique=True,
                                help_text="Введите username, не длиннее 50 символов. "
                                          "Использовать нужно английский алфавит, разделять фразы нужно символом '-'")
    ...
    self_esteem = models.DecimalField(max_digits=2,
                                      ...
                                      help_text="Введите уровень вашей самооценки, только честно!"
                                                " Градация от 0 до 5, где 0 - 'я молодец', 5 - 'я умница'",
                                      null=True,
                                      blank=True,
                                      )
